...
;
/* ../../../../libs/romochka/blocks-touch/i-ua/i-ua.js begin */
BEM.DOM.decl('i-ua', {
...
/* ../../../../libs/romochka/blocks-touch/i-ua/i-ua.js end */
;
...
BEM.DOM.decl('popup',  {
    ...
    _bindFocusEvents: function() {
        ...
        /* При закрытии выпадушки, возвращаем фокус в том место, откуда его сняли.
         * За исключением случаев, когда выпадушка закрылась по клику во вне.
         * То есть, возвращаем фокус только, если выпадушка была закрыта с клавиатуры. */
        this._skipReturnFocus = false;
        this.bindToDoc('mousedown.returnFocus', function() {
            this._skipReturnFocus = true;
        });
    ...
    _unbindFocusEvents: function() {
        ...
        this.unbindFromDoc('mousedown.returnFocus');
...
;
/* ../../../../touch-pad.blocks/popup/_adaptive/popup_adaptive_yes.js begin */
BEM.DOM.decl({
    block: 'popup',
    modName: 'adaptive',
    modVal: 'yes'
...
/* ../../../../touch-pad.blocks/popup/_adaptive/popup_adaptive_yes.js end */
;
